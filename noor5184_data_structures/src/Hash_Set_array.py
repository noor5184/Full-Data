...
class Hash_Set:
    ...
    def insert(self, value):
        ...
        Tracks the number of comparisons made to insert the value.
        Use: inserted = hs.insert(value)
        ---------------------------------------------------------
        Parameters:
            value - a comparable data element (has comparisons field)
        Returns:
        ...
        if value in slot:
            index = slot.index(value)
            slot[index].comparisons += value.comparisons
            return False
